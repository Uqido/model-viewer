...
import {AnimationAction, AnimationClip, AnimationMixer, Box3, Event as ThreeEvent, LoopOnce, Matrix3, Object3D, PerspectiveCamera, Raycaster, Scene, Vector2, Vector3} from 'three';
